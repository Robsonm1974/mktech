...
DROP FUNCTION IF EXISTS insert_planejamento_admin(
  UUID, VARCHAR, VARCHAR, TEXT, INTEGER, INTEGER, INTEGER, VARCHAR, VARCHAR
);

-- Criar nova função com ano_escolar_id
...
COMMENT ON FUNCTION insert_planejamento_admin IS 'Insere um planejamento com ano_escolar_id (atualizado)';
